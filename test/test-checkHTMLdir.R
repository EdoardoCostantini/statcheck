...
### Object:      checkHTMLdir function test
### Description: This script tests whether the extractions done using the stable version of checkHTMLdir (on CRAN) and
###              the version on which you are working on are giving the same results when applied to all the html 
